...
Vulnerability to corruption|5|6|6|2|4
Overall Security|5|6.5|5|5.5|6
...
Arguably, this is one area in which existing democracy does better, because it already has requirements in place on declaring political donations and oversight mechanisms. Corruption  happens, but politicians get punished for it. MiVote as it stands I believe is a bit more vulnerable and with greater consequence to its integrity, as it is part of the system that it decides the policy approaches to present through small groups of people, including its own internal committee. This leaves it vulnerable to corruption if there is not adequate transparency and accountability for people on the committee, such as whether they have any conflicts of interest. This I believe could be addressed with this transparency included. Flux doesn't really centralise any aspect of its decision-making, but it's still vulnerable to corruption in my view because it makes votes a tradable commodity. Also, voters can accumulate political capital to be spent (or delegated) later, which becomes potentially a recipe for vote-buying or bribing apathetic and greedy voters. Online Direct Democracy is less vulnerable to either of these risks because it isn't centralised, has no way to give your vote to anyone else, nor can you stockpile political capital for later use.

There is more to preventing corruption than simply reducing vote fraud. Arguably corruption is not something that can be addressed so much through a democratic decision-making system, but through practices of transparency through institutions such as independent media and external bodies keeping track of illicit financial flows.
